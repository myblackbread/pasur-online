// backend/supabase/functions/game-api/errors.ts

export const ErrorCode = {
    // Доступ
    UNAUTHORIZED: 'ERR_UNAUTHORIZED',
    NOT_ADMIN: 'ERR_NOT_ADMIN',
    USER_NOT_FOUND: 'ERR_USER_NOT_FOUND',      // 🟢 ДОБАВЛЕНО
    INVALID_REQUEST: 'ERR_INVALID_REQUEST',    // 🟢 ДОБАВЛЕНО
    ...
    ROOM_ALREADY_STARTED: 'ERR_ROOM_ALREADY_STARTED', // 🟢 ДОБАВЛЕНО
    ...
    // Сообщения админа (для трансляции в UI)
